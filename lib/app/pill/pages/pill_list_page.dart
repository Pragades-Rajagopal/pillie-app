...
// ScrollDirection is available from material.dart
...
class _PillListPageState extends State<PillListPage> {
  ...
  Future<void> _loadData() async {
    ...
    setState(() {
      user = fetchedUser;
      pillDatabase = user != null ? PillDatabase(user!.id!) : null;
    });
  }
      ...
      child: Scaffold(
        floatingActionButton: _showFab
            ? FloatingActionButton(
                onPressed: () {
                  // TODO: Show add pill bottom sheet
                },
